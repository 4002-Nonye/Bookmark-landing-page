  ...
  return (
    <nav className="flex  justify-between h-24 items-center transition m-auto w-[85%]">
      ...
      <div className="hidden lg:flex ">
        <Link linkText="Features" className="hoverRed transition" />
        <Link linkText="Pricing" className="hoverRed transition" />
        <Link linkText="Contact" className="hoverRed transition" />
